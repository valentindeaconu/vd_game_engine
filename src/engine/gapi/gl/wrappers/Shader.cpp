...
namespace vd::gl {
    ...
    void Shader::Allocate(const std::string& uniformName) {
        PassIfCreated();
    ...
    void Shader::Set(const std::string& uniformName, const glm::quat& value) {
        PassIfCreated();
    ...
    void Shader::Set(const std::string& uniformName, const glm::mat3& value) {
        PassIfCreated();
