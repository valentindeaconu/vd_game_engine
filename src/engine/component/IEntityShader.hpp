...
namespace vd::component {
    ...
    public:
        ...
        void UpdateUniforms(object::EntityPtr pEntity, uint32_t meshIndex) override;

        virtual void InitUniforms(object::Entity2DPtr pEntity) = 0;
        virtual void UpdateUniforms(object::Entity2DPtr pEntity, uint32_t meshIndex) = 0;
    };
    typedef std::shared_ptr<IEntity2DShader>    Entity2DShaderPtr;
    ...
    public:
        ...
        virtual void UpdateUniforms(object::Entity3DPtr pEntity, uint32_t meshIndex) = 0;
    };
