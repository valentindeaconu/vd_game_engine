...
namespace vd::core
{
    ...
    bool InputHandler::getWindowResized() const
    {
        return windowInfo.status == eWindowPreResize || windowInfo.status == eWindowPostResize;
    }

    WindowInfo InputHandler::getWindowSize() const
    {
    ...
    void InputHandler::mouseCallback(GLFWwindow* window, double xpos, double ypos)
    {
        ...
        this->mouseMovement.offset.x = (xpos - this->mouseMovement.curr.x) * this->kMouseSensitivity;
        this->mouseMovement.offset.y = (this->mouseMovement.curr.y - ypos) * this->kMouseSensitivity;
