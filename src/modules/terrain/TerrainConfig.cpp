...
namespace mod
{
	namespace terrain
	{
		...
		{
			if (command.compare("heightmap") == 0)
			{
				heightmap = imgLoaderPtr->loadFloatImage(tokens[0]);
				size = heightmap->height;
			}
			else if (command.compare("maxheight") == 0)
			{
				maxHeight = std::stof(tokens[0]);
			}
			else if (command.compare("biome") == 0)
			{
			...
			else if (command.compare("map_DIF") == 0)
			{
			...
			else if (command.compare("height_threshold_min") == 0)
			{
				biomeAtlas.back().height.min = std::stof(tokens[0]);
			}
			else if (command.compare("height_threshold_max") == 0)
			{
				biomeAtlas.back().height.max = std::stof(tokens[0]);
			}
			else if (command.compare("object") == 0)
			{
